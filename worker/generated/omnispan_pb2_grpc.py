...
class EngineStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEngineStats = channel.unary_unary(
                ...
                response_deserializer=omnispan__pb2.StatsReply.FromString,
                _registered_method=True)
...
def add_EngineServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetEngineStats': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=omnispan__pb2.StatsRequest.FromString,
                    response_serializer=omnispan__pb2.StatsReply.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'omnispan.Engine', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('omnispan.Engine', rpc_method_handlers)
...
class Engine(object):
    ...
    def GetEngineStats(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/omnispan.Engine/GetEngineStats',
            omnispan__pb2.StatsRequest.SerializeToString,
            omnispan__pb2.StatsReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
def add_WorkerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'omnispan.Worker', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('omnispan.Worker', rpc_method_handlers)
